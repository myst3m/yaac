...
(defn usage [summary-options]
  (->> ["Usage: nrepl [org] [env] <app> [options]"
        ""
        "Connect to a deployed Mule application's nREPL endpoint for interactive debugging."
        ""
        "URI Formats:"
        ...
        ""
        "# Connect with explicit org and env"
        "  > yaac nrepl T1 Production app://hello-api/nrepl"
        ""
        "# Use internal URL (for VPN/private network access)"
        "  > yaac nrepl app://hello-api/nrepl -i"
        ""
        "# Direct connection to public URL"
        "  > yaac nrepl https://hello-api.cloudhub.io/nrepl"
        ""
        ""]
       (str/join \newline)))
