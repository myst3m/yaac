...
_yaac_completions() {
    ...
    # --- Options per command ---
    local get_opts="-g --group -a --asset -v --version -Q --search-term -A --all -F --fields --type --describe --query --start --end --from --duration --aggregation --app-id --api-id --group-by --limit --offset --member --permission"
    local upload_opts="-g --group -a --asset -v --version -t --asset-type --api-version"
    local deploy_opts="-g --group -a --asset -v --version -Q --search-term -L --otel-endpoint --wait --no-wait --timeout"
